...
public final class VideoListDemoActivity extends Activity implements YouTubePlayer.OnFullscreenListener {
     ...
     */
    public static final class VideoListFragment extends android.app.ListFragment {
    ...
    private static final class PageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (view == null) {
                ...
                thumbnail.initialize(AppUtil.DEVELOPER_KEY, thumbnailListener);
            } else {
                YouTubeThumbnailView thumbnail = (YouTubeThumbnailView) view.findViewById(R.id.thumbnail);
    ...
    public static final class VideoFragment extends YouTubePlayerFragment
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            initialize(AppUtil.DEVELOPER_KEY, this);
        }
